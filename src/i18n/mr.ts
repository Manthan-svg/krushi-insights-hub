export const mr = {
  ...
  roles: { farmer: "शेतकरी", worker: "मजूर", equipmentOwner: "उपकरण मालक", selectRole: "तुमची भूमिका निवडा" },
  auth: { login: "लॉग इन", signup: "साइन अप", email: "ईमेल", password: "पासवर्ड", name: "पूर्ण नाव", phone: "फोन नंबर", forgotPassword: "पासवर्ड विसरलात?", noAccount: "खाते नाही?", hasAccount: "आधीच खाते आहे?", logout: "लॉग आउट" },
  ...
  common: { save: "जतन करा", cancel: "रद्द करा", submit: "सबमिट करा", loading: "लोड होत आहे...", noData: "डेटा उपलब्ध नाही", success: "यशस्वी!", error: "काहीतरी चूक झाली", language: "भाषा", settings: "सेटिंग्ज", status: { open: "खुले", closed: "बंद", pending: "प्रलंबित", accepted: "स्वीकारले", rejected: "नाकारले" } },
