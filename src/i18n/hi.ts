export const hi = {
  ...
  common: { save: "सहेजें", cancel: "रद्द करें", submit: "जमा करें", loading: "लोड हो रहा है...", noData: "कोई डेटा उपलब्ध नहीं", success: "सफलता!", error: "कुछ गलत हो गया", language: "भाषा", settings: "सेटिंग्स", status: { open: "खुला", closed: "बंद", pending: "लंबित", accepted: "स्वीकृत", rejected: "अस्वीकृत" } },
